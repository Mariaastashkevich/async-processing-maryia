...
def upgrade() -> None:
    ...
    sa.Column('job_status', sa.Enum('UPLOADED', 'VALIDATING', 'READY', 'FAILED', name='datasetstatus'), nullable=False),
    ...
    sa.Column('job_status', sa.Enum('PENDING', 'RUNNING', 'COMPLETED', 'FAILED', 'CANCELED', name='jobstatus'), nullable=False),
